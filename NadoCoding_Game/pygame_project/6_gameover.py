...
ball_images = [
    ...
    pygame.image.load(os.path.join(image_path,"balloon4.jpg"))
]
...
while running :
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            weapon_rect.left = weapon_pox_x
            weapon_rect.top = weapon_pox_y
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                # 가장 작은 크기의 공이 아니라면 다음 단계의 공으로 나뉨
                if ball_img_idx < 3:
                    # 현재 공 크기 정보를 가지고 옴
            ...
            continue    # 안쪽 for문의 조건이 맞지 않으면 continue
    ...
    for idx, val in enumerate(balls):
        ...
        ball_img_dox = val["img_idx"]
        screen.blit(ball_images[ball_img_dox], (ball_pos_x, ball_pos_y))
